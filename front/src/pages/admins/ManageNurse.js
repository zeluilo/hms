    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setPatients(response.data.nurse);
            } catch (error) {
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">Nurse Table</h5>
                                ...
                                <div className="datatable-container">
                                    {filteredPatients.length > 0 ? (
                                        ...
                                        <div className="table datatable datatable-table" style={{ padding: "10px" }}><strong>No Nurse Searched</strong></div>
                                    )}
                                </div>
                ...
                <div className="modal-dialog modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Edit Nurse Details</h5>
