    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setPatients(response.data.pharmacist);
            } catch (error) {
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">Pharmacist Table</h5>
                                ...
                                <div className="datatable-container">
                                    {filteredPatients.length > 0 ? (
                                        ...
                                        <div className="table datatable datatable-table" style={{ padding: "10px" }}><strong>No Pharmacist Searched</strong></div>
                                    )}
                                </div>
                ...
                <div className="modal-dialog modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Edit Pharmacist Details</h5>
