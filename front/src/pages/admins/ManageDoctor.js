    ...
    const filterPatients = (patients, term) => {
        ...
        const filtered = patients.filter((patient) => {
            ...
            return (
                ...
                patient.department.toLowerCase().includes(lowerCaseSearchTerm));
        });
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setPatients(response.data.doctor);
            } catch (error) {
                    ...
                    <div className="col-lg-12">
                        <div className="card">
                            <div className="card-body">
                                <h5 className="card-title">Doctors Table</h5>
                ...
                <div className="modal-dialog modal-dialog-scrollable">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">Edit Doctors Details</h5>
